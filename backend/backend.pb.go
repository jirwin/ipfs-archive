...
func (*ScrapeReq) Descriptor() ([]byte, []int) { return fileDescriptorBackend, []int{0} }
...
func (*ScrapeResp) Descriptor() ([]byte, []int) { return fileDescriptorBackend, []int{1} }
...
func (m *ScrapeResp) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func (*PinReq) Descriptor() ([]byte, []int) { return fileDescriptorBackend, []int{2} }
...
func (m *PinResp) Reset()                    { *m = PinResp{} }
func (*PinResp) ProtoMessage()               {}
func (*PinResp) Descriptor() ([]byte, []int) { return fileDescriptorBackend, []int{3} }
...
func (m *PinResp) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func init() {
	proto.RegisterType((*ScrapeReq)(nil), "backend.ScrapeReq")
	proto.RegisterType((*ScrapeResp)(nil), "backend.ScrapeResp")
	proto.RegisterType((*PinReq)(nil), "backend.PinReq")
	proto.RegisterType((*PinResp)(nil), "backend.PinResp")
}
func (this *ScrapeReq) Equal(that interface{}) bool {
	...
	that1, ok := that.(*ScrapeReq)
	if !ok {
		that2, ok := that.(ScrapeReq)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ScrapeResp) Equal(that interface{}) bool {
	...
	that1, ok := that.(*ScrapeResp)
	if !ok {
		that2, ok := that.(ScrapeResp)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ArchiveUrl != that1.ArchiveUrl {
		return false
	}
...
func (this *PinResp) Equal(that interface{}) bool {
	...
	that1, ok := that.(*PinResp)
	if !ok {
		that2, ok := that.(PinResp)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ScrapeResp) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&backend.ScrapeResp{")
	s = append(s, "Id: "+fmt.Sprintf("%#v", this.Id)+",\n")
	s = append(s, "ArchiveUrl: "+fmt.Sprintf("%#v", this.ArchiveUrl)+",\n")
...
func (this *PinResp) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&backend.PinResp{")
	s = append(s, "Id: "+fmt.Sprintf("%#v", this.Id)+",\n")
	s = append(s, "Error: "+fmt.Sprintf("%#v", this.Error)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringBackend(v interface{}, typ string) string {
...
func (c *backendServiceClient) Pin(ctx context.Context, in *PinReq, opts ...grpc.CallOption) (*PinResp, error) {
	out := new(PinResp)
	err := grpc.Invoke(ctx, "/backend.BackendService/Pin", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backendServiceClient) Scrape(ctx context.Context, in *ScrapeReq, opts ...grpc.CallOption) (*ScrapeResp, error) {
	out := new(ScrapeResp)
	err := grpc.Invoke(ctx, "/backend.BackendService/Scrape", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BackendService_Pin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PinReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).Pin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backend.BackendService/Pin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).Pin(ctx, req.(*PinReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _BackendService_Scrape_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScrapeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServiceServer).Scrape(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/backend.BackendService/Scrape",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).Scrape(ctx, req.(*ScrapeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BackendService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Pin",
			Handler:    _BackendService_Pin_Handler,
		},
		{
			MethodName: "Scrape",
			Handler:    _BackendService_Scrape_Handler,
		},
	},
...
func (m *ScrapeReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Url) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintBackend(dAtA, i, uint64(len(m.Url)))
		i += copy(dAtA[i:], m.Url)
	}
	return i, nil
}
...
func (m *ScrapeResp) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ArchiveUrl) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintBackend(dAtA, i, uint64(len(m.ArchiveUrl)))
		i += copy(dAtA[i:], m.ArchiveUrl)
	}
	if len(m.Error) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintBackend(dAtA, i, uint64(len(m.Error)))
...
func (m *PinReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Hash) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintBackend(dAtA, i, uint64(len(m.Hash)))
...
func (this *ScrapeReq) String() string {
	...
	s := strings.Join([]string{`&ScrapeReq{`,
...
func (this *ScrapeResp) String() string {
	...
	s := strings.Join([]string{`&ScrapeResp{`,
		`Id:` + fmt.Sprintf("%v", this.Id) + `,`,
		`ArchiveUrl:` + fmt.Sprintf("%v", this.ArchiveUrl) + `,`,
...
func (m *ScrapeReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ScrapeReq: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScrapeReq: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ScrapeResp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScrapeResp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScrapeResp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorBackend = []byte{
	...
	,
	...
	0xc5, 0x23, 0x39, 0x86, 0x0f, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0x48, 0x62, 0x03, 0xc7,
	0x89, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x5c, 0xbf, 0xc3, 0xdf, 0xa4, 0x01, 0x00, 0x00,
}
